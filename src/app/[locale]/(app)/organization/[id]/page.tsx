...
import { notFound } from 'next/navigation'; // Valid
    ...
    <div className="max-w-4xl mx-auto space-y-6">
        <div>
            <nav className="sm:hidden" aria-label="Back">
                <a href="/organization" className="flex items-center text-sm font-medium text-gray-500 hover:text-gray-700">
                ...
                <ol role="list" className="flex items-center space-x-4">
                    ...
                    <li>
                        <div className="flex items-center">
                            ...
                            <a href="/organization" className="ml-4 text-sm font-medium text-gray-500 hover:text-gray-700">Organization</a>
                        </div>
                    </li>
                    <li>
                         <div className="flex items-center">
                            <span className="flex-shrink-0 h-5 w-5 text-gray-300">/</span>
                            <span className="ml-4 text-sm font-medium text-gray-500" aria-current="page">Edit</span>
                        </div>
                    </li>
                </ol>
            </nav>
